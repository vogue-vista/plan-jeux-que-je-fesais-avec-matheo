# main.py (Version 100% Anti-Bug React/Streamlit)
...
# 1. INITIALISATION DE LA MÉMOIRE SÉCURISÉE
...
# ---- ÉTAPE 3 : LE JEU ----
    ...
    with st.container(key="zone_partie_principale"):
        ...
        with col_carte:
            ...
            for i, u in enumerate(st.session_state.unites):
        ...
        with col_controles:
            ...
            with st.form("atelier_invention", clear_on_submit=True):
                ...
                effet_inv = st.text_input("Que fait-elle ?", key="input_effet_invention")
